---
title: 编写爬虫自动下载王者荣耀官网上好看的壁纸
date: 2020/03/28 20:59:32
abbrlink: ab34b3d9211841a5
categories:
- Python
tags:
- Python
...
## 分析
这个网站长这样。
{% asset_img 8869373-f32d76f603857298.png %}
首先对腾讯这个网站进行分析。

这个每一个小图对应的`div`
{% asset_img 8869373-61819ae7225767cf.png %}

`<ul>`标签里面的列表就是各个尺寸的图片地址。
{% asset_img 8869373-4d8bf74f0fed0be6.png %}
...
{% asset_img 8869373-c068c4f46bcb566f.png %}
那么，只要分析这个每一页的超链接地址就行。
然鹅。
{% asset_img 8869373-2043f29e28d21490.png %}
...
果然，在点击第二页之后，抓到了这个：
{% asset_img 8869373-55d696d1f0346f6b.png %}
来看一下里面有什么：
{% asset_img 8869373-ade44aa19b6e1a24.png %}

看到`List`了！还有这些，这不就是我们要的下载的图片地址吗？？？
{% asset_img 8869373-9c488cd845199ad2.png %}
...
## 运行效果
{% asset_img 8869373-2e40a91323efb8c4.png %}

下载下来的图片：
{% asset_img 8869373-c6de7d4866ac860b.png %}
每个图片都下载了所有尺寸
{% asset_img 8869373-44af481ae8d41ea1.png %}
